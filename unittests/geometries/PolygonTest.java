...
public class PolygonTest {
    ...
    void testFindIntersections() {
        ...
        List<Point> points = p.findIntsersections(r1);
        ...
        assertNull(p.findIntsersections(r2),
        ...
        assertNull(p.findIntsersections(r5),
        ...
        assertNull(p.findIntsersections(r6),
